...
if (in_ip == self.server_ip) {
    ...
    switch code {
        case htme_packet.SERVER_GREETINGS:
            ...
            htme_debugger("htme_clientNetworking",htme_debug.INFOR,"Got greetings from server");
        ...
        case htme_packet.SERVER_PLAYERCONNECTED:
            ...
            ds_list_add(self.playerlist,playerhash);
            htme_debugger("htme_clientNetworking",htme_debug.INFOR,"Player "+playerhash+" connected.");
        break;
        case htme_packet.SERVER_PLAYERDISCONNECTED:
            ...
            htme_debugger("htme_clientNetworking",htme_debug.INFOR,"Player "+playerhash+" disconnected.");
        break;
