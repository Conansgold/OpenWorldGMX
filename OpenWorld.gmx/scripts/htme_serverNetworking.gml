...
if (!is_undefined(player)) {
    ...
    switch code {
        ...
        case htme_packet.CLIENT_ROOMCHANGE:
             ...
             htme_debugger("htme_serverNetworking",htme_debug.INFOR,"Player "+in_ip+":"+string(in_port)+" moved to room "+string(_room)+"!");
        ...
        case htme_packet.CLIENT_BYE:
             htme_debugger("htme_serverNetworking",htme_debug.INFOR,in_ip+":"+string(in_port)+" wants to disconnect");
