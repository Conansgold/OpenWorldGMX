...
if (!script_execute(self.serverEventHandlerConnect,ev_map)) {
    //CONNECTION REFUSED
    htme_debugger("htme_serverEventPlayerConnected",htme_debug.INFOR,"Connection for "+ip+":"+string(port)+" refused. Player will be disconnected.");   
...
htme_debugger("htme_serverEventPlayerConnected",htme_debug.INFOR,"CONNECTED TO CLIENT "+player+" . Adding to the playermap with hash "+playerhash);
