...
*/
self.debuglevel = htme_debug.INFOR;
...
htme_debugger("htme_init",htme_debug.INFOR,"SETTING UP GMnet CORE");
...
if (self.use_udphp) {
    htme_debugger("htme_init",htme_debug.INFOR,"Starting GMnet PUNCH...");
    var u_debug = false, u_silent = true;
    if (self.debuglevel <= htme_debug.INFOR) {u_debug=false;u_silent=false;}
